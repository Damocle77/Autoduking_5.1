...
# ================================================================================
# ducking_auto_serie_batch.sh – v1.5 "Protocollo Autodistruzione"
...
SCRIPT_DA_ESEGUIRE="./ducking_auto_stereo.sh"
...
mapfile -t mkv_files < <(find . -maxdepth 1 -type f -name "*.mkv" ! -name "*_stereo_ducked.mkv" -print0 | sort -zV | tr '\0' '\n')
